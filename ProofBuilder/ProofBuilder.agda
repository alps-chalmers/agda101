...
p0=>s3∧s5 : {pr : Prog p0} → pr ⊨ ◇ ((at (s 3)) ∧ (at (s 5)))
p0=>s3∧s5 = parRule p0=>s2 s2

p0=>s3' : {pr : Prog p0} → pr ⊨ ◇ (after (s 3))
p0=>s3' = ◇-∧-e₁ (:=n-R (◇-∧-e₁ p0=>s3∧s5) s3)

p0=>p1' : {pr : Prog p0} → pr ⊨ ◇ (after (prc 1))
p0=>p1' = fin-R (flow p0=>s3' s3) s4

p0=>s5' : {pr : Prog p0} → pr ⊨ ◇ (after (s 5))
p0=>s5' = ◇-∧-e₁ (:=n-R (◇-∧-e₂ p0=>s3∧s5) s5)

p0=>p2' : {pr : Prog p0} → pr ⊨ ◇ (after (prc 2))
